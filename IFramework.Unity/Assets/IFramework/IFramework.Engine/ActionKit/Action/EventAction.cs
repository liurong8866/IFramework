...
namespace IFramework.Engine
{
    ...
    public class EventAction : AbstractAction, IPoolable
    {
        ...
        protected override void OnDispose() { ObjectPool<EventAction>.Instance.Recycle(this); }
    ...
    public static class EventActionExtensions
    {
        ...
        /// 执行某事件
        /// </summary>
        public static void Action<T>(this T self, [NotNull] params Action[] actions) where T : MonoBehaviour { self.Execute(EventAction.Allocate(actions)); }
    }
}
