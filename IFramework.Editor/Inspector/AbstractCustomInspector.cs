...
namespace IFramework.Editor
{
    ...
    /// </summary>
    public abstract class AbstractCustomInspector : UnityEditor.Editor
    {
        ...
        protected AbstractCustomInspector(string editorTypeName)
        {
            ...
            if (originalEditedType != editedObjectType) {
                throw new ArgumentException(string.Format("Type {0} does not match the editor {1} type {2}", editedObjectType, editorTypeName, originalEditedType));
            }
        }
