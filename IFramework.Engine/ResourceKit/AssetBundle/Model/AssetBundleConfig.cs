...
namespace IFramework.Engine
{
    ...
    /// 资源数据管理类
    /// </summary>
    public sealed class AssetBundleConfig : IAssetBundleConfig
    {
        ...
        {
            int count= AddAssetBundleInfo(assetBundleName, depends, out AssetBundleInfo assetBundle);
            assetBundleInfo = assetBundle as IAssetBundleInfo;
            return count;
        }
